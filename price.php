    ...
    <div class="container">
        ...
        <div class="block">
            ...
            <ol class="price-list">
                ...
                <li>Объем заказа и автошин (1000 и более)</li>
                <li>Тело шипа:
                    <ul>
                        <li>аллюминий;</li>
                        <li>сталь;</li>
        ...
        <div class="block">
            ...
            <ol class="price-list">
                ...
                <br><i>1 автомобиль 120 м<sup>3</sup>: 1,5-2 часа разгрузка, 2 часа погрузка</i>
                </li>
                <li>Оформление документации
                <br><i>при отправке заказчику или непосредственно потребителю</i>
                </li>
                <li>Хранение шин
                <br><i>на период ошиповки и до 3-х дней после выполнения заказа</i>
                </li>
            </ol>
        </div>
        <figure>
